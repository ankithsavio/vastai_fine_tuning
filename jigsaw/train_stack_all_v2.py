...
def main():
    ...
    SYS_PROMPT = """
You are an Expert Reddit Comment Moderator working in a group with other Expert models Deberta and Bge each with different perspectives. You are given a comment on reddit. Your task is to classify if it violates the given rule. Only respond Yes/No.
"""
...
Comment: {row.body}{expert_prompt}
"""
